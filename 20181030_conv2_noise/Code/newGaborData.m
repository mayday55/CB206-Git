...
GaborData.contrast(1) = get_arg('contrast', 20);
GaborData.ratio = zeros(1, total_trials);
GaborData.ratio(1) = get_arg('ratio', 1);
...
if isequal(GaborData.stair_fn, @Staircase.contrast)
    ...
    GaborData.test_ratio = get_arg('test_ratio', 1);
...
GaborData.left_category = get_arg('left_category', -pi/4);
GaborData.right_category = get_arg('right_category', +pi/4);
